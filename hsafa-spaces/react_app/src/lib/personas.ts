...
export const PREBUILT_PERSONAS: Persona[] = [
  ...
  },
  {
    ...
    style:
      "Casual and entertaining. Loves puns, wordplay, and clever observations. Keeps things light but knows when to be serious. Uses emojis sparingly but effectively.",
    traits: [
  ...
  },
  {
    ...
    preview:
      "Ooh, now THIS is interesting! 🗺️ Let me dig into this — I think there's something really cool hiding in here...",
  },
];
