...
CREATE TABLE "runs" (
    ...
    "trigger_sender_entity_id" UUID,
    "trigger_sender_name" TEXT,
    "trigger_sender_type" TEXT,
    "trigger_service_name" TEXT,
    "trigger_payload" JSONB,
    "trigger_plan_id" UUID,
    "trigger_plan_name" TEXT,
    "trigger_plan_instruction" TEXT,
    "created_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ(6) NOT NULL,
...
-- CreateIndex
CREATE INDEX "runs_agent_entity_id_trigger_message_id_idx" ON "runs"("agent_entity_id", "trigger_message_id");
